/*
    Author(s): María Camila Betancourt (122260)
               Angie Natalia Guevara(122493)
    Date of the creation: 26/09/2024
    Last Modification: 10/10/2024 | 11:00am
*/
var scene = null,
    camera = null,
    renderer = null,
...
const size = 200,
    ...
    function createBuildings (px, py, pz, sizex, sizey, sizez, textures) {  
      ...
      switch (textures){
        case 1: 
          t = new THREE.TextureLoader().load('../src/img/Building.jpg');  
          c =0x454546;
          break;
        case 2:
          t = new THREE.TextureLoader().load('../src/img/ChrismasBuilding.jpg'); 
          c = 0x8c8c8c;
         break; 
        case 3:
          t = new THREE.TextureLoader().load('../src/img/edificio1.jpeg.jpg');         
          c= 0x454546;
         break;
          case 4:
          t = new THREE.TextureLoader().load('../src/img/edificio2.jpg');        
          c= 0x666666;
          break;
        case 5:
          t = new THREE.TextureLoader().load('../src/img/edificio3.jpg');        
          c= 0x666666;
          break;
        case 6:
          t = new THREE.TextureLoader().load('../src/img/petsBuilding.jpg');
          c= 0x8c8c8c;
          break;
    ...
    function addBuildings(){
     //parte de arriba
         ...
         //delante izq
         createBuildings(-64,20,-64,30,40,27.5,3);
         //atrás izq
    ...
    function createHighWay(){
      ...
      createStreet(45,90,2,'normal','90');
      createStreet(-45,90,2,'normal','90');
      createStreet(-45,-90,2,'normal','90');
      createStreet(45,-90,2,'normal','90');
      
      createStreet(90,45,2,'normal','');
      createStreet(90,-45,2,'normal','');
      createStreet(-90,-45, 2,'normal','');
      createStreet(-90,45,2,'normal','');

      createStreet(0,-45,2,'normal','');
      createStreet(0,45,2,'normal','');

      createStreet(88,-88,5,'corner','');
      createStreet(-88,-88,5,'corner','270');
      createStreet(88,88,5,'corner','90');
      createStreet(-88,88,-10,'corner','180');
    }
    ...
    function createStreet(px,pz,py,textura,rotacion){
      ...
      switch(textura){
          case 'normal':
             var t=new THREE.TextureLoader().load('../src/img/street1.png');
             geometry = new THREE.PlaneGeometry( 20, 130 );
             
          break;

          case 'corner':
            var  t=new THREE.TextureLoader().load('../src/img/street2.png');
    ...
    function createCar(px,pz){
      r1=null, r2=null, r3=null, r4=null, c1=null;
    ...
    const material1 = new THREE.MeshStandardMaterial( {color: 0x6f0c0c, metalness:1} ); 
    c1 = new THREE.Mesh( geometry1, material1 ); 
    c1.position.set(px-5,5, pz-3.5);
    scene.add( c1 );

    const geometry2 = new THREE.CubeGeometry( 9,5,7 ); 
    const material2 = new THREE.MeshStandardMaterial( {color: 0x6f0c0c, metalness:1} ); 
